"""One-off: real committee assessment of TSM (Taiwan Semiconductor
Manufacturing, NYSE ADR) alongside MU, plus correlation to the existing
basket. Not a permanent part of the pipeline; prints to the job log,
then this script and its workflow get deleted.
"""
...
CORR_BASKET = ["QQQM", "NBIS", "CRWV", "MU", "TSM"]

print("=" * 70)
print("Real 1-year correlation matrix (basket + TSM)")
print("=" * 70)
frames = {}
...
print()
print("=" * 70)
print("Eligibility + real committee assessment: TSM")
print("=" * 70)
...
print(f"  Name: {long_name} | Sector: {sector} | Industry: {industry} | Exchange: {exchange} | Type: {quote_type}")
